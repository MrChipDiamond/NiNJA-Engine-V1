...
void DrawAd()
{
	CL_DrawTextPhysical_BO1("^5Welcome to ^2Ninjas V1.0 ^7cracked engine ^2| ^5Enjoy using this piece of shit menu owned by a ^2faggot ^5that scams", 0x7FFFFFFF, BigDevFont, MovementBO2SP, 40, 1.3, 1, 0, Vector4(1, 1, 1, 1), 0);
